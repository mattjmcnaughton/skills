...
- A slug ("AGE-4-add-semantic-indexing") — derive worktree path and branch from it.
...
- Never `--force` the worktree removal or `-D` the branch without explicit confirmation.
